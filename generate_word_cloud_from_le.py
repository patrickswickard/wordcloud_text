...
def plot_wordcloud(wordcloud):
  ...
  plt.figure(figsize = (18, 24), dpi=300,facecolor = None)
...
def save_wordcloud(wordcloud,string):
  # plot the WordCloud image
  plt.figure(figsize = (18, 24), facecolor = None)
  plt.imshow(wordcloud)
  plt.axis("off")
  plt.tight_layout(pad = 0)
  plt.savefig('cache/le/' + str(string) + '.png')
#  # this is necessary without jupyter
#  plt.show()
  plt.close()

def get_all_litlistle():
  df = pd.read_csv('litlistle.csv')
  print(df)
